...
public_subnets           = ["subnet-xxxxxxxxxxxxxxxxx", "subnet-yyyyyyyyyyyyyyyyy"] # Dev public subnets
...
redshift_master_password = "devpassword"                                            # Handle securely (Vault or Secrets Manager)
env                      = "dev"
datadog_api_key_arn      = "arn:aws:secretsmanager:us-west-2:xxxxxxxxxxxx:secret:datadog-api-key-dev-abcdef" # Dev Datadog API key ARN
instance_count           = 1
...
kms_key_id               = "arn:aws:kms:us-west-2:xxxxxxxxxxxx:key/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" # Dev KMS key ARN
app_port                 = 8080