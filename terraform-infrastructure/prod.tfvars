...
public_subnets           = ["subnet-aaaaaaaaaaaaaaaaa", "subnet-bbbbbbbbbbbbbbbbb"] # Prod public subnets
...
redshift_master_password = "prodpassword"                                           # Handle securely (Vault or Secrets Manager)
env                      = "prod"
datadog_api_key_arn      = "arn:aws:secretsmanager:us-east-1:yyyyyyyyyyyy:secret:datadog-api-key-prod-ghijkl" # Prod Datadog API key ARN
...
kms_key_id               = "arn:aws:kms:us-east-1:yyyyyyyyyyyy:key/yyyyyyyy-yyyy-yyyy-yyyy-yyyyyyyyyyyy"      # Prod KMS key ARN
app_port                 = 8080